...
- React (для универсальности и удобства анимаций)  
- Next.js (SSR/SSG для SEO и производительности)  
- Tailwind CSS (стилизация, градиенты, адаптивность)  
- Framer Motion (плавные анимации и скролл-эффекты)  
- Lucide React (иконки)  
- Vercel (деплой с поддержкой Next.js)
